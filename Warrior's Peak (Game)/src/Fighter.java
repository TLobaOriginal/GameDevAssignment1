...
public class Fighter extends GameObject {
    ...
    public Fighter(String resourcePackageLocation, String textureLocation,
        ...
        audioMap.put("punch1", new Media(new File("Warrior's Peak (Game)/res/audio/punch1.wav").toURI().toString()));
        audioMap.put("punch2", new Media(new File("Warrior's Peak (Game)/res/audio/punch2.wav").toURI().toString()));
        audioMap.put("punch3", new Media(new File("Warrior's Peak (Game)/res/audio/punch3.wav").toURI().toString()));
    }

    @Override
    public void setTextureLocation(String textureLocation) {
        super.setTextureLocation(textureLocation);
    }
